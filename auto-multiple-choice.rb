class AutoMultipleChoice < Formula
  ...
  resource "auto-multiple-choice-precomp" do
    url "https://download.auto-multiple-choice.net/amc_1.3.0_precomp.tar.gz"
    sha256 "0c1644947ef316e88bbdcb7ff75237631de219bff3b7d1ba183c2796a18003dd"
  end
